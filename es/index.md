...
{% Aside%} Para obtener orientación adicional sobre cómo medir estas métricas mediante servicios de análisis populares (o sus propias herramientas de análisis internas), consulte: [Mejores prácticas para medir](/vitals-field-measurement-best-practices/) valores vitales web en el campo {% endAside%}
